...
class _HomeRouteState extends State<HomeRoute> {
  ...
  void initState() {
    ...
    Provider.of<NotificationsProvider>(context, listen: false)
        .fetchAndSetPlayerNotifications();
  }
...
class HomePageTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<LoginProvider>(
      builder: (context, loginProvider, _) => Consumer<NotificationsProvider>(
        builder: (context, notificationsProvider, _) => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
              ...
              children: [
                ...
                NotificationsButton(
                    notificationsProvider.unreadNotificationsCount)
              ],
            ),
            Padding(
...
class NotificationsButton extends StatelessWidget {
  ...
  NotificationsButton(this.count);
    ...
    return Stack(
      children: <Widget>[
        IconButton(
          ...
          onPressed: () =>
              Navigator.of(context).pushNamed(NotificationsRoute.routeName),
        ),
        if (count > 0)
          Positioned(
            top: 10,
